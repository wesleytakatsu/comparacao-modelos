...
const DATA_SOURCES = {
  ...
  'openai-gpt56-launch': {
    ...
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Documentação primária de lançamento GA da família GPT-5.6 (Sol, Terra, Luna). Terminal-Bench 2.1 88.8%, SWE-bench Pro 64.6%.'
  },
  'openai-gpt56-safety': {
  ...
  'openai-gpt56-preview': {
    id: 'openai-gpt56-preview',
    publisher: 'OpenAI',
    sourceType: 'official-model',
    title: 'Previewing GPT-5.6 Sol',
    domain: 'openai.com',
    path: '/index/previewing-gpt-5-6-sol/',
    sourceUrl: 'https://openai.com/index/previewing-gpt-5-6-sol/',
    publishedAt: '2026-06-26',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Anúncio e início do limited preview do GPT-5.6 Sol.'
  },
  'openai-o1-preview': {
    ...
    domain: 'openai.com',
    path: '/index/introducing-openai-o1-preview/',
    sourceUrl: 'https://openai.com/index/introducing-openai-o1-preview/',
    publishedAt: '2024-09-12',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento do OpenAI o1-preview com CoT deliberativo.'
  },
  'openai-o3-launch': {
    id: 'openai-o3-launch',
    publisher: 'OpenAI',
    ...
    domain: 'openai.com',
    path: '/index/introducing-o3-and-o4-mini/',
    sourceUrl: 'https://openai.com/index/introducing-o3-and-o4-mini/',
    publishedAt: '2025-04-16',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento público do modelo de raciocínio frontier OpenAI o3.'
  },
  'openai-gpt-oss-launch': {
    id: 'openai-gpt-oss-launch',
    publisher: 'OpenAI',
    sourceType: 'official-model',
    title: 'Introducing gpt-oss Open-Weights Models',
    domain: 'openai.com',
    path: '/index/introducing-gpt-oss/',
    sourceUrl: 'https://openai.com/index/introducing-gpt-oss/',
    publishedAt: '2025-08-05',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Liberação oficial dos modelos abertos gpt-oss-20b e gpt-oss-120b sob licença Apache 2.0.'
  },
  'anthropic-fable5-launch': {
    id: 'anthropic-fable5-launch',
    publisher: 'Anthropic',
    sourceType: 'official-model',
    title: 'Claude Fable 5 & Mythos 5 Release Announcement',
    domain: 'anthropic.com',
    path: '/news/claude-fable-5-mythos-5',
    sourceUrl: 'https://www.anthropic.com/news/claude-fable-5-mythos-5',
    publishedAt: '2026-06-09',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial da nova classe Ultra-Reasoning Claude Fable 5.'
  },
  'anthropic-fable5-redeploy': {
    id: 'anthropic-fable5-redeploy',
    publisher: 'Anthropic',
    sourceType: 'official-policy',
    title: 'Redeploying Claude Fable 5: Export Controls & Safeguards Update',
    domain: 'anthropic.com',
    path: '/news/redeploying-fable-5',
    sourceUrl: 'https://www.anthropic.com/news/redeploying-fable-5',
    publishedAt: '2026-06-30',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Anúncio de suspensão temporária em 12/06 e retorno à disponibilidade pública em 01/07/2026.'
  },
  'anthropic-sonnet5-launch': {
    id: 'anthropic-sonnet5-launch',
    publisher: 'Anthropic',
    sourceType: 'official-model',
    title: 'Claude Sonnet 5 Release',
    domain: 'anthropic.com',
    path: '/news/claude-sonnet-5',
    sourceUrl: 'https://www.anthropic.com/news/claude-sonnet-5',
    publishedAt: '2026-06-30',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial do Claude Sonnet 5 como sucessor geracional do Sonnet 4.6 ($2/$10).'
  },
  'anthropic-opus5-launch': {
    id: 'anthropic-opus5-launch',
    publisher: 'Anthropic',
    sourceType: 'official-model',
    title: 'Claude Opus 5: Frontier Heavyweight with 1M Native Context',
    domain: 'anthropic.com',
    ...
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial do Claude Opus 5 com saída expandida de 128k e contexto de 1M.'
  },
  'anthropic-fable51-launch': {
    id: 'anthropic-fable51-launch',
    publisher: 'Anthropic',
    sourceType: 'official-model',
    title: 'Claude Fable 5.1 Announcement',
    domain: 'anthropic.com',
    path: '/news/claude-fable-5-1',
    sourceUrl: 'https://www.anthropic.com/news/claude-fable-5-1',
    publishedAt: '2026-09-01',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento do Claude Fable 5.1 (CursorBench 73.4%, AA Index 66).'
  },
  'google-gemini-31-pro': {
    id: 'google-gemini-31-pro',
    publisher: 'Google DeepMind',
    sourceType: 'official-model',
    title: 'Gemini 3.1 Pro Preview Announcement',
    domain: 'blog.google',
    path: '/innovation-and-ai/models-and-research/gemini-models/gemini-3-1-pro/',
    sourceUrl: 'https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-1-pro/',
    publishedAt: '2026-02-19',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Preview do Gemini 3.1 Pro multimodal e raciocínio científico.'
  },
  'google-gemini-35': {
    id: 'google-gemini-35',
    publisher: 'Google DeepMind',
    sourceType: 'official-model',
    title: 'Gemini 3.5 Family Architecture & Rollout',
    domain: 'blog.google',
    path: '/innovation-and-ai/models-and-research/gemini-models/gemini-3-5/',
    sourceUrl: 'https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-5/',
    publishedAt: '2026-05-19',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Anúncio da família Gemini 3.5 no Google I/O com rollout de Flash e Pro.'
  },
  'google-deepmind-gemini-37': {
    id: 'google-deepmind-gemini-37',
    publisher: 'Google DeepMind',
    sourceType: 'official-model',
    title: 'Introducing Gemini 3.7 Flash with Dynamic Thinking',
    domain: 'blog.google',
    path: '/innovation-and-ai/models-and-research/gemini-models/introducing-gemini-3-7-flash/',
    sourceUrl: 'https://blog.google/innovation-and-ai/models-and-research/gemini-models/introducing-gemini-3-7-flash/',
    publishedAt: '2026-08-13',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial do Gemini 3.7 Flash com dynamic thinking (Terminal-Bench 2.1 85.8%).'
  },
  'google-deepmind-gemini-38': {
    id: 'google-deepmind-gemini-38',
    publisher: 'Google DeepMind',
    sourceType: 'official-model',
    title: 'Gemini 3.8 Flash and Gemini 3.8 Flash Cyber',
    domain: 'blog.google',
    path: '/innovation-and-ai/models-and-research/gemini-models/3-8-flash-and-3-8-flash-cyber/',
    sourceUrl: 'https://blog.google/innovation-and-ai/models-and-research/gemini-models/3-8-flash-and-3-8-flash-cyber/',
    publishedAt: '2026-09-02',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento do Gemini 3.8 Flash (90.8% TB 2.1) e variante restrita Cyber via Fairwind.'
  },
  'xai-grok-45': {
    id: 'xai-grok-45',
    publisher: 'xAI',
    ...
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial do Grok 4.5 com raciocínio aprimorado no cluster Colossus.'
  },
  'xai-grok-46': {
    id: 'xai-grok-46',
    publisher: 'xAI',
    sourceType: 'official-model',
    title: 'Grok 4.6 Release & Enterprise Expansion',
    domain: 'x.ai',
    path: '/news/grok-4-6',
    sourceUrl: 'https://x.ai/news/grok-4-6',
    publishedAt: '2026-08-12',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial do Grok 4.6 e disponibilidade multi-nuvem subsequente.'
  },
  'deepseek-v32-updates': {
    id: 'deepseek-v32-updates',
    publisher: 'DeepSeek AI',
    sourceType: 'official-model',
    title: 'DeepSeek V3.2 Architecture & Post-Training Optimization',
    ...
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Atualização oficial V3.2 focada em estabilidade de geração de código e JSON output.'
  },
  'deepseek-v4-preview': {
    id: 'deepseek-v4-preview',
    publisher: 'DeepSeek AI',
    sourceType: 'official-model',
    title: 'DeepSeek V4 Architecture Preview',
    domain: 'api-docs.deepseek.com',
    path: '/updates',
    sourceUrl: 'https://api-docs.deepseek.com/updates',
    ...
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Preview técnico da arquitetura DeepSeek V4 com MLA de 1M de tokens.'
  },
  'deepseek-v4-pro-ga': {
    id: 'deepseek-v4-pro-ga',
    publisher: 'DeepSeek AI',
    sourceType: 'official-model',
    title: 'DeepSeek V4 Pro Official GA (Checkpoint 0813)',
    domain: 'api-docs.deepseek.com',
    path: '/updates',
    sourceUrl: 'https://api-docs.deepseek.com/updates',
    publishedAt: '2026-08-13',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento GA do DeepSeek V4 Pro com score oficial de 62.7% no DeepSWE.'
  },
  'deepseek-v4-vision-exp': {
    id: 'deepseek-v4-vision-exp',
    publisher: 'DeepSeek AI',
    sourceType: 'official-model',
    title: 'DeepSeek V4 Vision Experimental Deployment',
    domain: 'api-docs.deepseek.com',
    path: '/updates',
    sourceUrl: 'https://api-docs.deepseek.com/updates',
    ...
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Disponibilização experimental da vertente de visão e OCR técnico da família V4.'
  },
  'qwen-25-max': {
    id: 'qwen-25-max',
    publisher: 'Alibaba Cloud Qwen Team',
    sourceType: 'official-model',
    title: 'Qwen2.5-Max: Frontier Dense Model Release',
    domain: 'qwenlm.github.io',
    path: '/blog/qwen2.5-max/',
    sourceUrl: 'https://qwenlm.github.io/blog/qwen2.5-max/',
    publishedAt: '2025-01-28',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial do modelo proprietário de altíssima escala Qwen2.5-Max.'
  },
  'qwen-38-max': {
    id: 'qwen-38-max',
    publisher: 'Alibaba Cloud',
    sourceType: 'official-model',
    title: 'Qwen 3.8 Max Model Studio Launch',
    domain: 'help.aliyun.com',
    path: '/en/model-studio/newly-released-models',
    sourceUrl: 'https://help.aliyun.com/en/model-studio/newly-released-models',
    publishedAt: '2026-08-02',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Disponibilização do Qwen 3.8 Max no Model Studio para inferência comercial.'
  },
  'qwen-38-flash': {
    id: 'qwen-38-flash',
    publisher: 'Alibaba Cloud',
    sourceType: 'official-model',
    title: 'Qwen 3.8 Flash Speed & High-Throughput Tier',
    domain: 'help.aliyun.com',
    path: '/en/model-studio/newly-released-models',
    sourceUrl: 'https://help.aliyun.com/en/model-studio/newly-released-models',
    publishedAt: '2026-08-26',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamento oficial do Qwen 3.8 Flash com alta densidade de processamento por dólar.'
  },
  'qwen-38-max-0902': {
    id: 'qwen-38-max-0902',
    publisher: 'Alibaba Cloud',
    sourceType: 'official-model',
    title: 'Qwen 3.8 Max Snapshot 0902 Update',
    domain: 'help.aliyun.com',
    path: '/en/model-studio/newly-released-models',
    sourceUrl: 'https://help.aliyun.com/en/model-studio/newly-released-models',
    publishedAt: '2026-09-02',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Snapshot 0902 com refinamentos de alinhamento e aderência a ferramentas.'
  },
  'moonshot-kimi-k26': {
    id: 'moonshot-kimi-k26',
    publisher: 'Moonshot AI',
    sourceType: 'official-model',
    title: 'Kimi K2.6 Frontier Context Window',
    domain: 'platform.moonshot.cn',
    path: '/docs/k26',
    sourceUrl: 'https://platform.moonshot.cn/docs/k26',
  ...
  'moonshot-kimi-k27': {
    id: 'moonshot-kimi-k27',
    publisher: 'Moonshot AI',
    sourceType: 'official-model',
    title: 'Kimi K2.7 Code Architecture Release',
    domain: 'platform.moonshot.cn',
    path: '/docs/k27-code',
    sourceUrl: 'https://platform.moonshot.cn/docs/k27-code',
    publishedAt: '2026-01-20',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Especialização em geração de código e refatoração de repositórios.'
  },
  'moonshot-kimi-k3': {
    id: 'moonshot-kimi-k3',
    publisher: 'Moonshot AI',
    sourceType: 'official-model',
    title: 'Kimi K3 Next-Generation Frontier',
    domain: 'platform.moonshot.cn',
    path: '/docs/k3',
    sourceUrl: 'https://platform.moonshot.cn/docs/k3',
    publishedAt: '2026-06-10',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Flagship de raciocínio de próxima geração da Moonshot AI.'
  },
  'minimax-m27': {
    id: 'minimax-m27',
    publisher: 'MiniMax',
    ...
    sourceUrl: 'https://api.minimax.chat/document/models',
  ...
  'minimax-m3': {
    ...
    publisher: 'MiniMax',
    sourceType: 'official-model',
    title: 'MiniMax M3 Frontier Reasoning',
    domain: 'api.minimax.chat',
    path: '/document/models',
    sourceUrl: 'https://api.minimax.chat/document/models',
    ...
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Nova geração de raciocínio frontier da MiniMax com 1M de contexto.'
  },
  'meta-muse-spark': {
    id: 'meta-muse-spark',
    publisher: 'Meta AI',
    sourceType: 'official-model',
    title: 'Meta Muse Spark Research & Weights',
    domain: 'ai.meta.com',
    path: '/blog/muse-spark/',
    sourceUrl: 'https://ai.meta.com/blog/muse-spark/',
    publishedAt: '2026-04-18',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Linhagem de modelos de raciocínio e engenharia de software da Meta AI.'
  },
  'tencent-hy': {
    id: 'tencent-hy',
    publisher: 'Tencent Hunyuan',
    sourceType: 'official-model',
    title: 'Tencent Hunyuan Model Updates & Previews',
    domain: 'hunyuan.tencent.com',
    path: '/news',
    sourceUrl: 'https://hunyuan.tencent.com/news',
    publishedAt: '2026-07-05',
    retrievedAt: '2026-09-02',
    official: true,
    notes: 'Lançamentos e previews públicos da linhagem Hunyuan (Hy3 e Hy4 Preview).'
  },
  'deepswe-datacurve-v11': {
    id: 'deepswe-datacurve-v11',
    publisher: 'DataCurve',
    sourceType: 'independent-benchmark',
    title: 'DataCurve DeepSWE v1.1 Independent Benchmark Run',
    domain: 'datacurve.ai',
    path: '/benchmarks/deepswe',
    sourceUrl: 'https://datacurve.ai/benchmarks/deepswe',
    publishedAt: '2026-09-02',
    retrievedAt: '2026-09-03',
    official: false,
    notes: 'Execuções metrológicas independentes do DeepSWE 1.1.'
  },
  'snorkel-terminal-bench-science': {
    id: 'snorkel-terminal-bench-science',
    publisher: 'Snorkel AI',
    sourceType: 'independent-benchmark',
    title: 'Snorkel AI Terminal-Bench Science Leaderboard',
    domain: 'snorkel.ai',
    path: '/leaderboard/terminal-bench-science/',
    sourceUrl: 'https://snorkel.ai/leaderboard/terminal-bench-science/',
    publishedAt: '2026-09-03',
    retrievedAt: '2026-09-03',
    official: false,
    notes: 'Avaliação independente de ciência e código no Terminal-Bench.'
  },
  'artificial-analysis-sep2026': {
    id: 'artificial-analysis-sep2026',
    publisher: 'Artificial Analysis',
    sourceType: 'independent-benchmark',
    title: 'Artificial Analysis Intelligence Index & Coding Evaluations (Set/2026)',
    domain: 'artificialanalysis.ai',
    path: '/evaluations/september-2026',
    sourceUrl: 'https://artificialanalysis.ai/evaluations/september-2026',
    publishedAt: '2026-09-03',
    retrievedAt: '2026-09-03',
    official: false,
    notes: 'Avaliações de código e inteligência independente.'
  },
  'livecodebench-v6': {
    id: 'livecodebench-v6',
    publisher: 'LiveCodeBench Team',
    sourceType: 'community-benchmark',
    title: 'LiveCodeBench v6 Release & Evaluation Leaderboard',
    domain: 'livecodebench.github.io',
    path: '/leaderboard.html',
    sourceUrl: 'https://livecodebench.github.io/leaderboard.html',
    publishedAt: '2026-08-15',
    retrievedAt: '2026-09-02',
    official: false,
    notes: 'Leaderboard comunitário de geração e síntese de código.'
  }
};
